...
import styles from './CreativeCurvesTemplate.module.css';
import {
  PhoneIcon,
  EnvelopeIcon,
  MapPinIcon,
...
export default function CreativeCurvesTemplate({ data }: Props) {
  ...
  return (
    <div className={`${styles.resume} stretch-template`}>
      {/* Decorative top right corner shape */}
      <div className={styles.topRightShape}></div>
      ...
      <main className={styles.main}>
        ...
        {experience.length > 0 && (
          <>
            ...
            <div className={styles.entryListMain}>
              {experience.map(exp => (
